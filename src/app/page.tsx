    ...
    <div className="bg-slate-50">
      ...
      <section className=" bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className=" mx-auto grid max-w-2xl grid-cols-1 px-1 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className=" flex flex-auto flex-col gap-4 lg:pr-8 xl:pr20`">
            ...
            <div className=" flex flex-auto flex-col gap-4 lg:pr-8 xl:pr20`">
              ...
              <div className=" text-lg leading-8">
                <p className="">
                  ...
                  and that led to sum pretty heavy scratch marks on all of my
